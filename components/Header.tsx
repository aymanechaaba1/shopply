...
function Header() {
  const { user } = useUser();
  let itemCount = useBasketStore((state) =>
        ...
        <div className="flex items-center space-x-4 mt-4 sm:mt-0 flex-1 md:flex-none">
          ...
          <ClerkLoaded>
            <SignedIn>
              <Link
                href={`/orders`}
                className="flex items-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded justify-center gap-x-2"
              >
